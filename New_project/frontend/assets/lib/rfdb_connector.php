...
switch ($id) {
    ...
    case 1:
        ...
        if ($catid == null && $build_id == null) {
            ...
            $sqlfdata = "SELECT id,bd_id,code_place,floor,cat_id,owner,name,detail,LogoImgName FROM agency_item";
            ...
            $sqlfdata = "SELECT id,bd_id,code_place,floor,cat_id,owner,name,detail,LogoImgName FROM agency_item WHERE cat_id=$catid";
            ...
            $sql = "SELECT id,bd_id,code_place,floor,cat_id,owner,name,detail,LogoImgName FROM agency_item WHERE bd_id='$build_id'";
            echo "----------";
            echo getdata($sql, $conn);
        } else if ($catid != '' && $build_id != '') {
            $sql = "SELECT id,bd_id,code_place,floor,cat_id,owner,name,detail,LogoImgName FROM agency_item WHERE cat_id='$catid' AND bd_id='$build_id'";
