        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <h5 class="m-0 text-dark">Report Category</h5>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div id="search_bd" class="ml-3 float-left">
                                    </div>
                                    <div id="search" class="ml-3 float-left">
                                    </div>
                                    <div id="search_cat" class="ml-3 float-left">
                                    </div>
                                </div>
                                <div class="card-body">
...
<script src="../../assets/js/report/index_2.js"></script>
