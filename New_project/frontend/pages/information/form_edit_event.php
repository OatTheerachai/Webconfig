        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h5 class="m-0 text-dark">เเก้ไขข้อมูล</h5>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-10">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title" style="line-height: 2.1rem;">เเก้ไขข้อมูล</h3>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <!-- <div class="form-group col-sm-6">
                                                <label for="customFile">รูปโปรไฟล์ 
                                                    ...
                                                    <div class="dropzone" id="mydropzone_video">
                                                    </div>
                                            </div> -->
                                        </div>
                                    </div>
...
<script src="../../assets/js/information/form_edit_event.js"></script>
<!-- <script>
